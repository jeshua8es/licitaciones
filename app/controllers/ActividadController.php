...
class ActividadController
{
    ...
    // Agrega este método a tu ActividadController
    public function listar()
    {
        // Obtener todas las actividades de la BD
        ...
        // Pasar a la vista
        $this->view->render('actividades/listar', [
            'actividades' => $actividades,
            'total' => $total,
            'ultimaImportacion' => $this->getUltimaImportacion()
        ]);
    }

    private function getUltimaImportacion()
    {
        // Obtener fecha de última actividad agregada
        $ultima = $this->actividadModel->getUltimaFecha();
        return $ultima ? date('d/m/Y H:i', strtotime($ultima)) : 'Nunca';
    }
}
